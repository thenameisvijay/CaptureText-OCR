package com.hybridtech.vijay.ocrworld.Core.ExtraViews;
...
import com.hybridtech.vijay.ocrworld.R;
...
public class FocusBoxView extends View {
    ...
    public void onDraw(Canvas canvas) {
        ...
        canvas.drawCircle(frame.left - 14, frame.top - 14, 14, paint);
        canvas.drawCircle(frame.right + 14, frame.top - 14, 14, paint);
        canvas.drawCircle(frame.left - 14, frame.bottom + 14, 14, paint);
        canvas.drawCircle(frame.right + 14, frame.bottom + 14, 14, paint);*/
    }
}
